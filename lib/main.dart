import 'package:class_practise_28/groupe_page.dart';
          ...
          child: ListView(
            ...
            children: <Widget>[
              Container(
                child: UserAccountsDrawerHeader(
                  ...
                  currentAccountPicture: CircleAvatar(
                    backgroundImage: AssetImage('image/cp.jpg'),
                  ),
              ...
              ListTile(
                ...
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => GroupePage(),));
                },
              ),
              ListTile(
